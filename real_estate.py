class Property:
    ...
    def prompt_init():
        return dict(
            ...
            baths = input("Enter the Bathrooms: ")
        )
...
class Apartment(Property):
    ...
    def prompt_init():
        ...
        laundry = get_valid_input(input_string="what laundry facilities does the property have?",valid_options=Apartment.valid_laundries)
...
#---------------------------------- building a purchase and rental class --------------------------#
